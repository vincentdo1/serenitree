    ...
    <div className="bg-white max-w-sm pb-6 pt-6 sm:pb-4 lg:pt-12">
      ...
      <div className="mx-5">
        ...
        <div className="pt-4 pb-1 px-0 mx-auto max-w-screen-xl text-center lg:py-16">
          ...
          <p className="my-2 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-400">It's time for a new journey.</p>
        </div>

        <div className="pt-2 pb-1 px-0 mx-auto max-w-screen-xl text-center lg:py-16">
          {/* <h1 className="my-3 text-3xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Parseltongue, Jese!</h1> */}
          <div className="flex flex-col sm:flex-row sm:justify-center sm:space-y-0">
              <Link className="inline-flex justify-center items-center py-3 px-8 text-base font-medium text-center text-white rounded-lg bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 dark:focus:ring-green-900" href='/reflection_quest'>
                  Reflect
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="mx-1 w-6 h-6">
